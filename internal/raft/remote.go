...
//
// remote.go is used for tracking the state of remote raft node.
// borrowed some flow control related idea from etcd raft, but the flow
// control here in remote.go is much simpler.
//
